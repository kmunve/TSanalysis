...
fimex --input.file=http://thredds.met.no/thredds/dodsC/arome25/arome_metcoop_default2_5km_20150908_06.nc --input.type=netcdf \
...
--output.file=Data/rauland_t.nc --output.type=nc4

# Correct the extraction time - maybe make a python script that collects data daily.
...
--output.file=Data/lofoten_t.nc --output.type=nc4
